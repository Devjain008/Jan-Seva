...
def get_greeting():
    ...
    if hour < 12:
        return "Good Morning" if st.session_state.get("language", "en") == "en" else "सुप्रभात"
    elif hour < 17:
        return "Good Afternoon" if st.session_state.get("language", "en") == "en" else "नमस्कार"
    else:
        return "Good Evening" if st.session_state.get("language", "en") == "en" else "शुभ संध्या"
