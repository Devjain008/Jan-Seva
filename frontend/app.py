...
# ═════════════════════════════════════════════════════════════════════════════
def render_sidebar():
    # HIDE STREAMLIT AUTO-GENERATED PAGE MENU
    st.markdown("""
    <style>
        section[data-testid="stSidebar"] nav { display: none !important; }
        div[data-testid="stSidebarNav"] { display: none !important; }
        .st-emotion-cache-1wq4gl3 { display: none !important; }
...
def _render_description(lang: str) -> None:
    ...
    if fc()["voice_applied"] and fc()["voice_text"]:
        note = ("🎤 Voice text applied — edit freely above."
                if lang == "en" else "🎤 आवाज़ टेक्स्ट लागू — ऊपर संपादित करें।")
        st.markdown(
...
div[data-testid="stButton"].dd-reject > button,
div[data-testid="stButton"].dd-remove > button{{
